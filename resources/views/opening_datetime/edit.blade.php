        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <input name="opening" id="opening" type="time"
                    value="@if($item->opening != null){{ $item->opening->format('H:i') }}@endif" class="from-control">
            </div>
            <div class="col-md-4">
                <label for="closing" class="form-label">Sluiting</label>
                <input name="closing" id="closing" type="time"
                    value="@if($item->closing != null){{ $item->closing->format('H:i') }}@endif" class="from-control">
            </div>
        </div>
