...
@section('content')
    <h1 class="display-5 section-title mb-4">Bewerken</h1>
    <form
        method="post"
        action="{{ route('opening-datetime.edit', ['openingDatetime' => $item]) }}"
    ...
    >
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <select name="open" id="open" class="from-control">
            ...
            <div class="col-md-4">
                ...
                <input
                    ...
                    id="opening"
                    type="time"
                    value="@if($item->opening != null){{ $item->opening->format('H:i') }}@endif"
                    class="from-control"
                />
            </div>
            <div class="col-md-4">
                ...
                <input
                    ...
                    id="closing"
                    type="time"
                    value="@if($item->closing != null){{ $item->closing->format('H:i') }}@endif"
                    class="from-control"
                />
            </div>
        </div>
