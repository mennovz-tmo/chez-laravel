                ...
                <form action="{{ route('register.submit') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input required type="password" class="form-control" id="password" name="password" min="12"
                            max="128" placeholder="Sterk wachtwoord..." value="{{ old('password') }}" class="form-input">
                    </div>
                    <div class="mb-3">
                        ...
                        <input required type="password" class="form-control" id="password_confirmation"
                            name="password_confirmation" min="12" max="128" placeholder="Herhaal..." class="form-input">
                    </div>
