...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .value { color: #3E2723; font-weight: 400; }
        .number-box {
            margin-top: 16px;
        ...
        .comment { margin-top: 14px; font-size: 12px; }
...
@endphp
    ...
    <div class="card">
        ...
        <p class="card-sub">Gemaakt op {{ $reservation->created_at }} &middot; {{ $reservation->amount_of_people }} {{ $reservation->amount_of_people == 1 ? 'persoon' : 'personen' }}</p>
    ...
    <div class="footer-note">Annuleren of wijzigen kan tot 12 uur voor de reservering. Toon je reserveringsnummer bij aankomst.</div>
</body>
</html>
