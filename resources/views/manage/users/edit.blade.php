...
@section('content')
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <h1 class="display-5 section-title mb-4">Gebruiker {{ $user['name'] }} aanpassen</h1>
            <form
                action="{{ route('manage.users.edit.store', $user) }}"
                method="post"
            ...
            >
                ...
                @csrf
                <button type="submit" class="btn btn-primary m-2">Gebruiker aanpassen</button>
            </form>
        </div>
    </div>
@endsection
