...
@section('content')
    <div class="row justify-content-center">
        <div class="col-lg-7">
            ...
            <form action="recipe/create" method="post" enctype="multipart/form-data" class="card p-4 shadow-sm"
                ...
                <div class="mb-3">
                    ...
                    <textarea required class="form-control" name="description_short" id="description_short" rows="3"
                        ...
                        style="border-radius:2px;background:var(--earth-paper);border-color:var(--earth-light);color:var(--earth-dark);">{{ old('description_short') }}</textarea>
                </div>
                <div class="mb-3">
