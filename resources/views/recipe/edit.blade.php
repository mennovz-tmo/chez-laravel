            ...
            <form action="edit" method="post" enctype="multipart/form-data" class="card p-4 shadow-sm card-body-container">
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" class="form-control" id="name" name="name"
                        value="{{ $current_data['name'] }}" class="form-input">
                </div>
                <div class="mb-3">
                    ...
                    <textarea required class="form-control" name="description_short" id="description_short" rows="3"
                        class="form-input">{{ $current_data['description_short'] }}</textarea>
                </div>
                <div class="mb-3">
